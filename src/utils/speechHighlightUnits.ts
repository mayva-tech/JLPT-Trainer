...
/** English / Japanese shared comma breath (`,` / `、`). */
 ...
 * Same ms as EN `,` (SPEECH_COMMA_PAUSE_MS). Mid-string commas may also be
...
/** English ";" / ":" clause breath (colon keeps general chain weight). */
