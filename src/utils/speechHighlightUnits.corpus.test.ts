...
/** Full-corpus karaoke walk is CPU-heavy under parallel suite load. */
const CORPUS_KARAOKE_TIMEOUT_MS = 15_000;

describe("final karaoke audit", () => {
  it(
    "has no lone だ/です/ます units outside intentional もとだと",
    () => {
      const bad: string[] = [];
